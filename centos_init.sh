...
# ------------------------------------------------------------------------------
# Fecha: 09 Marzo 2016
# Instalacion y configuracion Servidor Linux CentOS7 o RHEL7
# Autor: jcramirez
# Copyright 2016
# Version: 1.1
# Revision: jcramirez
...
echo -e "**********************************************************"
yum -y --nogpgcheck install yum-plugin-priorities epel-release bind-utils traceroute telnet finger wget autoconf automake libtool make gcc tree net-tools perl gcc make kernel-headers kernel-devel vim nano iperf3 iptraf-ng dstat ntpdate nfs-utils samba-client cifs-utils nmap iftop htop 
if [ $? -ne 0 ]
then
...
echo -e "*                                                                        *"
echo -e "**************************************************************************\n\n"
echo -e " En caso de alguna falla o Bug:,\n favor reportarlo a jcramirez@rcntv.com.co \n gracias....\n"
while :
do
